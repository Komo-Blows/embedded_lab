...
module soc_system_mm_interconnect_0 (
	...
	wire  [128:0] pio_out_s1_agent_rp_data;                                                           // pio_out_s1_agent:rp_data -> router_010:sink_data
	...
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> pio_out_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_out_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // pio_out_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_out_s1_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> pio_out_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> pio_out_s1_burst_adapter:sink0_endofpacket
	...
	wire          pio_out_s1_agent_rdata_fifo_out_valid;                                              // pio_out_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] pio_out_s1_agent_rdata_fifo_out_data;                                               // pio_out_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          pio_out_s1_agent_rdata_fifo_out_ready;                                              // avalon_st_adapter_005:in_0_ready -> pio_out_s1_agent_rdata_fifo:out_ready
